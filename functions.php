...
function add_style(){
    ...
    wp_enqueue_style( 'fotorama', get_template_directory_uri() . '/css/fotorama.css', array('my-bootstrap-extension'), '1'); 
     wp_enqueue_style( 'owl', 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/43033/owl.carousel.css', array('my-bootstrap-extension'), '1');  
}
...
function add_script(){
    ...
    wp_enqueue_script( 'owl', 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/43033/owl.carousel.min.js', array(), '1');
